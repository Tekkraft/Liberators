...
public class OperationPrepController : MonoBehaviour
{
    ...
    public void startOperation()
    {
        ...
        SquadData player = new SquadData(10, unitList, new List<Vector2Int>() { new Vector2Int(0, -12), new Vector2Int(0, -11) }, operationsTeam.PLAYER, new Vector3(-22.5f, -14.5f, -1f), "Player Squad", operationsAI.PLAYER);
